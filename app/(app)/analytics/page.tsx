...
function filterIdeasByRange(items: Idea[], cutoff: { from: Date | null; to: Date | null }): Idea[] {
...
function filterLogsByRange(items: ConversationLog[], cutoff: { from: Date | null; to: Date | null }): ConversationLog[] {
  if (!cutoff.from && !cutoff.to) return items;
